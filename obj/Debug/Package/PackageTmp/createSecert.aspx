<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createSecert.aspx.cs" Inherits="Final.createSecert" %>
		...
		<div class="comment">
			<div class="speechPane">
               <form id="form1" runat="server">
                ...
                <br />
                 <br />
                     <asp:Button ID="Button_createtable" runat="server" height="40px" Width="253px" 
                         style="font-size: 30px;" Text="进入加密论坛" onclick="Button1_Click" />
                <br />
                 <br />
                    取消，返回主页<a href="HomePage.aspx" >点击取消</a>
                    <br />
                    <br />
              </div>
              </form>
